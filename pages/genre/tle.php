...
$sql = "
    ...
    FROM library_books 
    WHERE category_id = (SELECT id FROM categories WHERE name = 'TLE')
    UNION ALL
...
<body>
    ...
    <div class="container">
        <section class="book-section">
            <h2>Technology and Livelihood Education BOOKS</h2>
            <div class="book-grid">
                <?php
                if (!empty($books)) {
                    foreach ($books as $book) {
                        echo '<div class="book-item">';
                        echo '<img src="./tle-icon.png" alt="Book Icon" class="book-icon">';
